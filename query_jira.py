...
def get_all_jira_data_paginated():
    ...
    for issue in issues:
        ...
        if hasattr(issue.fields, 'customfield_11220'):
            if hasattr(issue.fields.customfield_11220, 'value'):
                regression_value = issue.fields.customfield_11220.value
            else:
                regression_value = issue.fields.customfield_11220
...
def job():
    ...
    print("Job bug found query finished.")

# Gọi hàm job() trực tiếp để chạy test ngay lập tức
